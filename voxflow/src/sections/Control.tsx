    ...
    <div className="content-inner">
      ...
      <div className="card">
        ...
        <Field
          ...
          hint="В hold-режиме двойной быстрый тап оставляет запись включённой. Только одиночный тап короче 180 мс ждёт до 300 мс; обычное удержание завершается сразу."
        >
          <Switch
