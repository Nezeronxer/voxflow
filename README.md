...
![status](https://img.shields.io/badge/platform-Windows-blue) ![version](https://img.shields.io/badge/version-0.4.0-green) ![privacy](https://img.shields.io/badge/privacy-local%20or%20BYOK-orange)
...
Локальный pre-release installer собирается сюда:

```powershell
installer\Output\VoxFlow-Setup-0.4.0.exe
```
