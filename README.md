...
![version](https://img.shields.io/badge/version-2.0.2-6b7cff)
...
|---|---|---|
| macOS Apple Silicon | macOS 11+, ARM64 | `VoxFlow-macOS-2.0.2-arm64-adhoc.dmg` |
| Windows | Windows 10/11, x64 | `VoxFlow-Setup-2.0.2.exe` |
