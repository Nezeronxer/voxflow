# VoxFlow v2.0.1 — стабильный macOS + Windows

Patch-релиз заменяет v2.0.0 и одновременно выпускается для macOS Apple Silicon
и Windows x64. Он исправляет повреждённую подпись прежнего macOS-пакета,
плавающую плашку, разрешения диктовки, двойной Right Option и неожиданно долгую
обработку короткого текста на Windows.
...
- Двойной быстрый Right Option снова включает режим без удержания по умолчанию,
  включая одноразовую миграцию настроек 2.0.0. Только одиночный тап короче
  180 мс ждёт 300-мс окно; обычная диктовка завершается сразу при отпускании.
...
- `VoxFlow-Setup-2.0.1.exe`
- `SHA256SUMS-windows.txt`
- `VoxFlow-macOS-2.0.1-arm64-adhoc.dmg`
- `VoxFlow-macOS-2.0.1-arm64-adhoc.app.zip`
- `SHA256SUMS.txt`
